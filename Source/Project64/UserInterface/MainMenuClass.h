...
enum MainMenuID
{
    ...
    ID_OPTIONS_CONFIG_AUDIO, ID_OPTIONS_CONFIG_CONT, ID_OPTIONS_CONFIG_RSP, ID_SYSTEM_CHEAT, ID_OPTIONS_CPU_USAGE,
    ...
    //Help Menu
    ID_HELP_STOCKHOMEPAGE, ID_HELP_HOMEPAGE, ID_HELP_ABOUTSETTINGFILES, ID_HELP_ABOUT,

	//Netplay
	ID_NETPLAY_REPLACESAVES, ID_NETPLAY_ME, ID_NETPLAY_UPDATE_EMU
};
